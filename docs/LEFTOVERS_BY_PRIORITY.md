...
|----|-----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|------------|
| 15 | **Don't** | **Fatigue meter Phase 2** — decay, technique modifier, `/fatigue` page, multi-channel SFR, API endpoints                                                                    | Owner-gated; Stage 4 closed 2026-05-20 with no threshold changes. **Phase 2 planning extracted 2026-05-23 to [`fatigue_meter/PHASE2_PLANNING.md`](fatigue_meter/PHASE2_PLANNING.md)** (status: "planning extracted / awaiting owner decision" — D2.x decisions not yet walked). Do not edit `utils/fatigue.py`, `tests/test_fatigue.py`, or `scripts/fatigue_calibration_report.py::SCENARIOS` without fresh owner override. | — |
