...
- [ ] P9e-add: Create `navbar.css`; link it additively in the navbar block while leaving both source links present. Test. Commit. **Local implementation + validation complete 2026-04-22; commit pending. Source sum 1,428 lines, target 1,429 lines (+0.07%).**
