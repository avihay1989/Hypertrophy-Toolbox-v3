...
**Status:** §3 (Simple-mode body-map hybrid swap, workout-plan only) shipped 2026-04-29. §5 YouTube modal and §4 free-exercise-db media still pending; §3.6 Profile coverage body map remains deferred. See [`EXECUTION_LOG.md`](EXECUTION_LOG.md) for the §3 audit trail.
