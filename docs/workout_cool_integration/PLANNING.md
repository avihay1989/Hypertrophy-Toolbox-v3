...
**Status:** §3 (Simple-mode body-map hybrid swap, workout-plan only) shipped 2026-04-29. §5 (YouTube reference video modal, both `/workout_plan` and `/workout_log`) shipped on `main` 2026-05-11. §4 free-exercise-db media is next; §3.6 Profile coverage body map remains deferred. See [`EXECUTION_LOG.md`](EXECUTION_LOG.md) for the audit trail.
